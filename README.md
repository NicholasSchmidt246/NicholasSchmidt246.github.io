...
As a student, I have learned how to use the mongo console to set up, manage, and delete mongo databases without a GUI. Ironically, I learned how to interface with Mongo due to my job, but only using the GUI that comes with the Cosmos DB, which does not support renaming, or early on, even deleting collections. After taking my course using mongo, I have since been able to repair some old mistakes without incurring additional costs. I have also learned some more industry standards for REST web services, and more importantly, found the documents that define the industry standards. For work, I had to learn to shoot from the hip and make an API and web services from just about nothing. I was working off stack overflow and a few other sites that seemed to define them. Due to needing to cite sources for my assignments, I have discovered that these sites were not the origin of the information as I thought they were. Knowing the location of the W3C request for comments papers as well as identifying them as the authority on the matter is a huge step in helping me collaborate in a team environment as well as being versed in current industry standards for web services which will help communicate to stakeholders exactly what they can expect / need. I have learned the concept of big O notation and that the speed of your algorithm can be impacting heavily by design decisions, harking on the importance of having a solid plan before starting any work. I have written in Java, Python, R, C, C++, C#, visual basic, Solaris, VHDL, and many other languages. While I currently have the most experience in C#, I can quickly pick back up any of the others I have used. While I am certain there is much more to them than I experienced initially, I have no doubts I will be able to pick any language up quickly. I started looking into security while working on Web Services and databases. It was not uncommon to hear of a company getting hit by SQL injection or a DDoS attack, and how much data is compromised, etc. W3C and OWASP have some insight into what can be done to prevent those as early as in design.
